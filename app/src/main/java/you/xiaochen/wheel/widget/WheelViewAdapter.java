...
//        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.wheel_oritation,parent,false);
...
//    class WhellViewHolder extends RecyclerView.ViewHolder{
//
//        TextView text;
//
//        public WhellViewHolder(View itemView) {
//            super(itemView);
